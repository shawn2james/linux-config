...
--               { ppOutput = hPutStrLn xmonadpipe                          -- xmobar on monitor 1
...
main = do
		xmproc0 <- spawnPipe "xmobar -x 0 /home/shawn/.config/xmobar/xmobarrc; xmonad --restart"
		picompipe <- spawnPipe "picom"
