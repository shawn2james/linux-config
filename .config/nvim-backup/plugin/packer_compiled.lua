...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/emmet-vim",
    url = "https://github.com/mattn/emmet-vim"
  },
  ["goyo.vim"] = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/goyo.vim",
    url = "https://github.com/junegunn/goyo.vim"
  },
  gruvbox = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/gruvbox",
    url = "https://github.com/morhetz/gruvbox"
  },
  ["indentpython.vim"] = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/indentpython.vim",
  ...
  ripgrep = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/ripgrep",
    url = "https://github.com/BurntSushi/ripgrep"
  },
  syntastic = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/syntastic",
  ...
  ["vim-dogrun"] = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/vim-dogrun",
    url = "https://github.com/wadackel/vim-dogrun"
  },
  ["vim-flake8"] = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/vim-flake8",
  ...
  ["vim-ripgrep"] = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/vim-ripgrep",
    url = "https://github.com/jremmen/vim-ripgrep"
  },
  vimwiki = {
    loaded = true,
    path = "/home/shawn/.local/share/nvim/site/pack/packer/start/vimwiki",
